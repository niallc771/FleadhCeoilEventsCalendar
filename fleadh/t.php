...
include_once($_SERVER['DOCUMENT_ROOT'].'/wordpress/wp-content/plugins/ajax-event-calendar-changes/ajax-event-calendar.php');
...
<head>
	...
	<![endif]-->
	<link rel="stylesheet" id="jq_ui_css-css" href="/wordpress/wp-content/plugins/ajax-event-calendar-changes/css/jquery-ui-1.8.16.custom.css?ver=1.8.16" type="text/css" media="all">
	<link rel="stylesheet" id="custom-css" href="/wordpress/wp-content/plugins/ajax-event-calendar-changes/css/custom.css?ver=1.0.4" type="text/css" media="all">
...
<body class="wp-admin wp-core-ui js
	...
	<div id="wpwrap">
			...
			<div id="wpbody">
				...
				<div id="wpbody-content" aria-label="Main content" tabindex="0">
    					<div id="screen-meta" class="metabox-prefs">
                		   ...
                		   <?php 
                    		   $aec->render_admin_calendar(); // helps render the catgories 
                		   ?>
		...
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.fullcalendar.min.js?ver=1.5.3"></script>
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.simplemodal.1.4.3.min.js?ver=1.4.3"></script>
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.jgrowl.min.js?ver=1.2.5"></script>
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.timePicker.min.js?ver=5195"></script>
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.mousewheel.min.js?ver=3.0.6"></script>
		<script type="text/javascript" src="/wordpress/wp-content/plugins/ajax-event-calendar-changes/js/jquery.init_admin_calendar.js?ver=1.0.4"></script>
        		<script type="text/javascript">
                    $(function() {
                    $( ".picker" ).datepicker();
                    });
