...
jQuery(document).ready(function ($) {
	filter = function (active) {
            ...
            // Code for changing button click on categories goes here

    /* filter = function (active) { 
            	$('#aec-filter li').click(function(){ 
         	    if($(this).hasClass('active')) 
                { 
                    $(this).fadeTo(0, 0.5).removeClass('active') calendar.fullCalendar('rerenderEvents'); 
                } 
                else 
                { 
                    $(this).fadeTo(250, 1).addClass('active') calendar.fullCalendar('rerenderEvents'); 
                } */
